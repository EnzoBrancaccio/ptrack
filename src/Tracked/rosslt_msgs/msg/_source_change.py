...
class Metaclass_SourceChange(type):
    """Metaclass of message 'SourceChange'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'rosslt_msgs.msg.SourceChange')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__source_change
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__source_change
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__source_change
            cls._TYPE_SUPPORT = module.type_support_msg__msg__source_change
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__source_change
...
class SourceChange(metaclass=Metaclass_SourceChange):
    """Message class 'SourceChange'."""
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser_definition.BasicType('int32'),  # noqa: E501
        rosidl_parser_definition.UnboundedString(),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        self.new_value = kwargs.get('new_value', str())
    ...
    def new_value(self, value):
        if __debug__:
            assert \
                isinstance(value, str), \
                "The 'new_value' field must be of type 'str'"
