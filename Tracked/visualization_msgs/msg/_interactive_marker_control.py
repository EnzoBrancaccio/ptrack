...
class InteractiveMarkerControl(metaclass=Metaclass_InteractiveMarkerControl):
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser_definition.NamespacedType(['geometry_msgs', 'msg'], 'Quaternion'),  # noqa: E501
        rosidl_parser_definition.BasicType('uint8'),  # noqa: E501
        rosidl_parser_definition.BasicType('uint8'),  # noqa: E501
        rosidl_parser_definition.BasicType('boolean'),  # noqa: E501
        rosidl_parser_definition.UnboundedSequence(rosidl_parser_definition.NamespacedType(['visualization_msgs', 'msg'], 'Marker')),  # noqa: E501
        rosidl_parser_definition.BasicType('boolean'),  # noqa: E501
        rosidl_parser_definition.UnboundedString(),  # noqa: E501
    )
