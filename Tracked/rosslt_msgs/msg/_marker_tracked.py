...
class Metaclass_MarkerTracked(type):
    """Metaclass of message 'MarkerTracked'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'rosslt_msgs.msg.MarkerTracked')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__marker_tracked
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__marker_tracked
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__marker_tracked
            cls._TYPE_SUPPORT = module.type_support_msg__msg__marker_tracked
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__marker_tracked
...
class MarkerTracked(metaclass=Metaclass_MarkerTracked):
    """Message class 'MarkerTracked'."""
    ...
    _fields_and_field_types = {
        ...
        'data': 'visualization_msgs/Marker',
    }

    SLOT_TYPES = (
        rosidl_parser_definition.NamespacedType(['rosslt_msgs', 'msg'], 'LocationHeader'),  # noqa: E501
        rosidl_parser_definition.NamespacedType(['visualization_msgs', 'msg'], 'Marker'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from visualization_msgs.msg import Marker
        self.data = kwargs.get('data', Marker())
    ...
    def data(self, value):
        if __debug__:
            ...
            assert \
                ...
                "The 'data' field must be a sub message of type 'Marker'"
        self._data = value
