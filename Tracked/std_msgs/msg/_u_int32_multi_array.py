...
class UInt32MultiArray(metaclass=Metaclass_UInt32MultiArray):
    ...
    SLOT_TYPES = (
        rosidl_parser_definition.NamespacedType(['std_msgs', 'msg'], 'MultiArrayLayout'),  # noqa: E501
        rosidl_parser_definition.UnboundedSequence(rosidl_parser_definition.BasicType('uint32')),  # noqa: E501
    )
