...
class ParameterValue(metaclass=Metaclass_ParameterValue):
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser_definition.BasicType('int64'),  # noqa: E501
        rosidl_parser_definition.BasicType('double'),  # noqa: E501
        rosidl_parser_definition.UnboundedString(),  # noqa: E501
        rosidl_parser_definition.UnboundedSequence(rosidl_parser_definition.BasicType('octet')),  # noqa: E501
        rosidl_parser_definition.UnboundedSequence(rosidl_parser_definition.BasicType('boolean')),  # noqa: E501
        rosidl_parser_definition.UnboundedSequence(rosidl_parser_definition.BasicType('int64')),  # noqa: E501
        rosidl_parser_definition.UnboundedSequence(rosidl_parser_definition.BasicType('double')),  # noqa: E501
