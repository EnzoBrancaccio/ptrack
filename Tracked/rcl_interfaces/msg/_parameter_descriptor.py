...
class ParameterDescriptor(metaclass=Metaclass_ParameterDescriptor):
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser_definition.BoundedSequence(rosidl_parser_definition.NamespacedType(['rcl_interfaces', 'msg'], 'FloatingPointRange'), 1),  # noqa: E501
        rosidl_parser_definition.BoundedSequence(rosidl_parser_definition.NamespacedType(['rcl_interfaces', 'msg'], 'IntegerRange'), 1),  # noqa: E501
    )
