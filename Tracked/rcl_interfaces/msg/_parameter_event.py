...
class ParameterEvent(metaclass=Metaclass_ParameterEvent):
    ...
    SLOT_TYPES = (
        rosidl_parser_definition.NamespacedType(['builtin_interfaces', 'msg'], 'Time'),  # noqa: E501
        rosidl_parser_definition.UnboundedString(),  # noqa: E501
        rosidl_parser_definition.UnboundedSequence(rosidl_parser_definition.NamespacedType(['rcl_interfaces', 'msg'], 'Parameter')),  # noqa: E501
        rosidl_parser_definition.UnboundedSequence(rosidl_parser_definition.NamespacedType(['rcl_interfaces', 'msg'], 'Parameter')),  # noqa: E501
        rosidl_parser_definition.UnboundedSequence(rosidl_parser_definition.NamespacedType(['rcl_interfaces', 'msg'], 'Parameter')),  # noqa: E501
    )
